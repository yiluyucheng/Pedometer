...
public class HFSeekBarHint extends SeekBar implements SeekBar.OnSeekBarChangeListener {
    ...
    public interface OnSeekBarHintProgressChangeListener {
        public String onHintTextChanged(HFSeekBarHint seekBarHint, float progress);
    }

    public HFSeekBarHint(Context context) {
        super(context);
        init(context, null);
    }

    public HFSeekBarHint(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public HFSeekBarHint(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    public void initShow(){
        ...
        mPopup.showAtLocation(this, Gravity.START | Gravity.BOTTOM, (int)(this.getX()+(int) getXPosition(this)), (int) (HFSeekBarHint.this.getY()+2*mYLocationOffset+ HFSeekBarHint.this.getHeight()));
